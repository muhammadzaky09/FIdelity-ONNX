...
from inject_ops import create_quantized_fault_injection,  create_random_bitflip_injection, create_random_fault_injection, create_quantized_fault_injection_weight, create_input16_mask, create_weight16_mask, create_fp16_fault_injection, create_fp16_fault_injection_weight
...
def modify_onnx_graph_input(config, fault_model, bit_position=3, precision='int8'):
...
def modify_onnx_graph_weight(config, fault_model, bit_position=3, precision='int8'):
