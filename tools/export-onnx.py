...
class Predictor():
    def __init__(self):
        self.device = 'cuda'
        self.model = LlamaForCausalLM.from_pretrained("meta-llama/Llama-2-7b-hf", token="")
        self.model.to(self.device)
        self.tokenizer = LlamaTokenizer.from_pretrained("meta-llama/Llama-2-7b-hf", token="")
